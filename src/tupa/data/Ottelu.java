...
public class Ottelu implements Serializable {
    ...
    public void asetaKotiKokoonpano(Kokoonpano koti) {
        this.koti_kokoonpano = koti;
    }

    public void asetaVierasKokoonpano(Kokoonpano vieras) {
        this.vieras_kokoonpano = vieras;
    }
